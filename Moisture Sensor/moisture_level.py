...
# Initialize a ROS node named 'moisture_node'
rospy.init_node('moisture_node', anonymous=True)

# Print a message to indicate that the moisture sensing node has started
print("Started Moisture Sensing node")

# Create a ROS publisher to publish moisture level data to the '/moisture_level' topic
